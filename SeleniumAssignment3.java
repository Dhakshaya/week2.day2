...
public class SeleniumAssignment3 {
	public static void main(String[] args) {
	    ...
	    String titleResultingPage = driver.getTitle();
	    System.out.println(titleResultingPage);
	    //DuplicateButton
	    WebElement duplicateButton = driver.findElement(By.linkText("Duplicate Lead"));
	    duplicateButton.click();
	    
	    //NewObj - for entering new CompanyName in Duplicate Lead
	    WebElement duplicateNewCompanyName = driver.findElement(By.id("createLeadForm_companyName"));
	    duplicateNewCompanyName.clear();
	    duplicateNewCompanyName.sendKeys("TestleafCompanyName");
	    
	    //NewObj - for entering new CompanyName in Duplicate Lead
	    WebElement duplicateNewfirstName = driver.findElement(By.id("createLeadForm_firstName"));
	    duplicateNewfirstName.clear();
	    duplicateNewfirstName.sendKeys("Dhakshayana");
	    
	    
	    //createLeadButton.click();
	    WebElement createLeadInDuplicate = driver.findElement(By.className("smallSubmit"));
	    createLeadInDuplicate.click();
	    
	    
	    
	    //getTitle	    
	    String titleDuplicatePage = driver.getTitle();
	    System.out.println(titleDuplicatePage);
